...
const EmailVerify = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen mt-15'>
        <form onSubmit={onSubmitHandler} className='bg-primary p-8 rounded-lg shadow-lg w-96 text-sm'>
            <h1 className='text-white text-2xl font-semibold text-center mb-4'>Vérification de votre adresse email via code OTP</h1>
            ...
            <button className='w-full py-3 bg-[#35d5bd] text-white rounded-full'>Verifier email</button>
        </form>
    </div>
  )
}
